...
sys.path.append('D:/CANLAB/WoodScape/omnidet/')
...
def test_simple(args):
    ...
    # encoder_path = 'D:/CANLAB/WoodScape/omnidet/res18/encoder.pth'
    semantic_decoder_path = os.path.join(args.pretrained_weights, "semantic.pth")
    # semantic_decoder_path = 'D:/CANLAB/WoodScape/omnidet/res18/semantic.pth'
