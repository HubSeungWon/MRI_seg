...
from detection_utils import crop_annotation
...
class WoodScapeRawDataset(data.Dataset):
    ...
    def get_image(self, index, cropped_coords, frame_index, cam_side):
        recording_folder = "train/rgbImages" if index == 0 else "previous_images"
    ...
    def get_detection_label(self, crop_coords, frame_index, cam_side):
        ...
        if os.stat(path).st_size != 0:
            ...
            w /= self.original_res_w
            x_c /= self.original_res_w
            h /= self.original_res_h
            y_c /= self.original_res_h
            ...
            if self.crop:
                ...
                cropped_boxes = crop_annotation(boxes, cropping,
                                                ...
                                                orginial_image_size=(self.original_res_w, self.original_res_h),
    ...
    def create_and_process_training_items(self, index):
        ...
        frame_index = self.image_paths[index].split('.')[0]

        # print(frame_index, cam_side)
